...
#                     if tile == 3:
#                         riceClass.append(
#                             rice.rice(farmRiceImg, screen, tilePos))
#                     pos[0] += 32
#                     tilePos[0] += 1
#                 pos[1] += 32
#                 tilePos[1] += 1
...
#             match event.key:
#                 # group: moves
#                 case pygame.K_LEFT: dir = Direction.LEFT
#                 case pygame.K_RIGHT: dir = Direction.RIGHT
#                 case pygame.K_UP: dir = Direction.UP
#                 case pygame.K_DOWN: dir = Direction.DOWN
...
#                         {"tile": farm.tileMap, "inv": playerClass.inventory, "pos": playerClass.pos}))
#                     save.close()
#                     logs.info("저장")
